...
function PasswordReset() {
    ...
    const handleSubmit= () => {
        ...
        if(email === 'trinhnv@jvb-corp.com') {
            if(newPassword === '') {
                ...
                setIsErrorNewPassword(true)
                setNoticeNewPassword('Password phải có độ dài tối thiểu 8 ký tự, và phải có ít nhất 1 chữ in hoa và ký tự đặc biệt')
            } else if(regexNewPassword.test(newPassword)) {
    ...
    <div className={cx('website')}>
        <div className={cx('login')}>
            <h1 className={cx('passwordReset__heading')}>
                Quên mật khẩu
            </h1>
            <div className={cx('passwordReset__content')}>
                ...
                {success && 
                    <div className={cx('login__notice')}>
                        <div className={cx('login__notice--content')}>Bạn đã đổi Password thành công</div>
                        <ListItemIcon>
