    ...
    <div className={cx('website')}>
      <div className={cx('login')}>
        <form>
          ...
          {errorEmail && <Error notice= {noticeEmail} className={cx('error')} />}
          ...
          <input 
            ...
            type='password'
          />
          {errorPassword && <Error notice= {noticePassword} className={cx('error')} />}
          ...
          <div className={cx('login__confirm')}>
            ...
            <span onClick={handleResetPassWord}>Quên mật khẩu?</span>
          </div>
